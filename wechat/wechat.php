...
class Wx {
	...
	private function createImage($obj,string $media){
		$xml = "<xml>
		...
		<Image>
		<MediaId><![CDATA[LenCZZSAyrsPDPtiIv5jE_Ziyn_F-i9Fypq6VS1gjhVCHDrH87IW2EVPFhUSpB4q]]></MediaId>
		</Image>
	  </xml>";
			return sprintf($xml,$this->obj->FromUserName,$this->obj->ToUserName,time(),$media);
			// return sprintf($this->config['text'],$this->obj->FromUserName,$this->obj->ToUserName,time(),$media);
